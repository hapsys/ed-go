...
-->
	<xsl:template name="view_materials">
		...
		<div class="clearfix"></div>
		<div class="form-materials updated-by-stomp" data-update-function="updateFromServer" data-update-interval="30000" data-update-tag="user-materials" data-update-pilot="{$pilot}">
