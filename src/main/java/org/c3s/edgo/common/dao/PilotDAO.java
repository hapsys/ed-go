...
public class PilotDAO {
	...
	public static void insertUpdateMissionMaterial(long pilot_id, long material_id, int count) throws IllegalArgumentException, IllegalAccessException, InstantiationException, SQLException {
